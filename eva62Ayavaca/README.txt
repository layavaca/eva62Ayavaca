...
a persistence unit "eva62AyavacaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62Ayavaca/pom.xml":
...
artifact ("eva62Ayavaca.war") is already built. You can build
